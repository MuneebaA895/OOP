...
public:
    void setWidth(double);    // Function prototype for setWidth
    void setLength(double);   // Function prototype for setLength
    double getWidth() const;    // Function prototype for getWidth
    double getLength() const;   // Function prototype for getLength
    double getArea() const;     // Function prototype for getArea
};
